...
def eval_libero(cfg: GenerateConfig) -> None:
    ...
    if cfg.num_tasks is not None:
        if cfg.num_tasks > num_tasks_in_suite:
            print(f"WARNING: Requested to run {cfg.num_tasks} tasks, but only {num_tasks_in_suite} available.")
        num_tasks_to_run = min(cfg.num_tasks, num_tasks_in_suite)
